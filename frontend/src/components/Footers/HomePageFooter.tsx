        ...
        <div className="w-[1104px] flex flex-col items-start gap-8 flex-[0_0_auto] relative">
            ...
            <div className="inline-flex flex-col items-start flex-[0_0_auto] relative gap-[21px]">
                <div className="w-[1104px] flex items-start gap-3 flex-[0_0_auto] relative">
                    <TypographyFooter>Audio Description</TypographyFooter>
                    <TypographyFooter>Help Center</TypographyFooter>
                    <TypographyFooter>Gift Cards</TypographyFooter>
                    <TypographyFooter>Media Center</TypographyFooter>
                </div>
                <div className="w-[1104px] flex items-start gap-3 flex-[0_0_auto] relative">
                    <TypographyFooter>Investor Relations</TypographyFooter>
                    <TypographyFooter>Jobs</TypographyFooter>
                ...
                <div className="w-[1104px] flex items-start gap-3 flex-[0_0_auto] relative">
                    ...
                    <TypographyFooter>Contact Us</TypographyFooter>
                </div>
