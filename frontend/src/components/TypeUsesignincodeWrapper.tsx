...
export const TypeUsesignincodeWrapper = ({
  ...
  return (
    <button className="cursor-pointer all-[unset] box-border flex flex-col w-[314px] h-10 items-center justify-center gap-4 px-6 py-3 relative bg-transparent-white20 rounded">
      <div
